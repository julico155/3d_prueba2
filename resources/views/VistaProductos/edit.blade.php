                ...
                <div class="grid grid-cols-2 px-8 py-4 gap-4">
                    <div id="gridColumns" class="col-span-2 lg:col-span-2">
                        ...
                        <div class="mb-6 space-x-2">
                            ...
                            <input type="checkbox" name="es_3d" id="es_3d" {{ $p->es_3d ? 'checked' : '' }}
                    ...
                    <div id="3dFields" style="display: {{ $p->es_3d ? 'block' : 'none' }};" class="col-span-2 lg:col-span-1">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="descripcion_3d" id="descripcion_3d"
                                class="border border-gray-400 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:border-green-500">{{ $p->descripcion_3d }}</textarea>
                        </div>

                        <div class="mb-6">
                            <label for="precio_3d" class="text-gray-600 font-semibold text-sm">Precio del modelo 3d: (BOB)</label>
                            <input type="number" name="precio_3d" id="precio_3d" value="{{ $p->precio_3d }}"
                                class="border border-gray-400 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:border-green-500">
                        </div>
                        ...
                        <div class="flex gap-4">
                            <div class="px-4 mb-6 space-x-2">
                                ...
                                <input type="checkbox" name="es_formato_obj" id="es_formato_obj" {{ $p->es_formato_obj ? 'checked' : '' }}
                                    class="border border-gray-400 rounded-lg py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:border-green-500">
                            </div>
                            <div class="mb-6 space-x-2">
                                <label for="es_formato_gltf" class="text-gray-600 font-semibold text-sm">.gltf </label>
                                <input type="checkbox" name="es_formato_gltf" id="es_formato_gltf" {{ $p->es_formato_gltf ? 'checked' : '' }}
                                    class="border border-gray-400 rounded-lg py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:border-green-500">
                            </div>
                            <div class="mb-6 space-x-2">
                                <label for="es_formato_fbx" class="text-gray-600 font-semibold text-sm">.fbx </label>
                                <input type="checkbox" name="es_formato_fbx" id="es_formato_fbx" {{ $p->es_formato_fbx ? 'checked' : '' }}
                                    class="border border-gray-400 rounded-lg py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:border-green-500">
                            </div>
                            <div class="mb-6 space-x-2">
                                <label for="es_formato_stl" class="text-gray-600 font-semibold text-sm">.stl </label>
                                <input type="checkbox" name="es_formato_stl" id="es_formato_stl" {{ $p->es_formato_stl ? 'checked' : '' }}
                                    class="border border-gray-400 rounded-lg py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:border-green-500">
                            </div>
                        </div>
                    </div>
