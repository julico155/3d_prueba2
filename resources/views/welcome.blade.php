...
@section('cliente')
        ...
        <div class="container mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 px-4 text-center">
            @foreach ($productos as $producto)
                <div class="bg-white rounded-2xl p-4 flex flex-col items-center transition transform duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl ">
                    <a href="{{ route('producto.show', $producto) }}" class="no-underline hover:no-underline ">
                        <div class="relative">
    ...
    <section class="bg-gray-100 p-16">
        <div class="container mx-auto flex items-center justify-between">
            <div class="flex grid grid-cols-2 gap-8 justify-center items-center">
                ...
                <div class="col-span-2 md:col-span-1">
                    <img src="{{ asset('img/contacto.png') }}" alt="Imagen de contacto" class="rounded-lg shadow-lg h-64 w-64">
                </div>
            </div>
        </div>
    </section>
