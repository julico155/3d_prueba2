...
<?php $__env->startSection('producto'); ?>
    <div class="container mx-auto px-4 my-4">
        ...
        <br>
        <div class="mt-4 sm:ml-4">
            <a href="<?php echo e(route('producto.create')); ?>" class="bg-green-500 text-white px-4 py-2 rounded-md mr-2">Registrar Productos</a>
        </div>
                ...
                <?php $__currentLoopData = $categoria->productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white p-4 shadow-md">
                        <div class="grid grid-cols-[1fr,3fr]">
                            <div>
                                <img src="<?php echo e(asset('storage/' . $producto->imagen1)); ?>" alt="Foto del producto" class="w-24 h-24 mb-2">
                                <a href="<?php echo e(route('producto.edit', $producto->id)); ?>" class="bg-blue-500 text-white px-4 py-2 rounded-md mr-2">Editar</a>
                            </div>
                            <div class="ml-4">
                                ...
                                <div class="flex items-center">
                                    <form action="<?php echo e(route('producto.destroy', $producto->id)); ?>" method="POST" class="inline-block">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <a href="<?php echo e(route('generarimagen', $producto->id)); ?>" class="bg-blue-500 text-white px-4 py-2 rounded-md ml-2">Image Gen</a>
                                </div>
                            </div>
                        </div>
                    </div>
