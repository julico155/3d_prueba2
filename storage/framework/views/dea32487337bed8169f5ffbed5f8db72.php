                ...
                <form action="<?php echo e(route('producto.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="color" id="color"
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $colores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
